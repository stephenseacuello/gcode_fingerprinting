...
5-fold means.
\item \textbf{Multiple-comparisons correction.} Holm-Bonferroni applied
across all (ablation, metric) pairs reported in
Table~\ref{tab:anova}. BH-FDR also computed for the less-conservative
reading. Significance at $\alpha=0.05$ is reported under both
adjustments.
\end{itemize}
